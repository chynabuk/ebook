//package com.application.electronic_book.filter;
//
...
//        String accessToken = JwtUtil.generateAccessToken(user.getEmail(), request.getRequestURL().toString(), (Collection<GrantedAuthority>) user.getAuthorities());
//        response.setContentType(APPLICATION_JSON_VALUE);
